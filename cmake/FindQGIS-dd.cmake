...
# Set local QGIS path
set(LOCAL_QGIS_PATH "${CMAKE_SOURCE_DIR}/dependencies/QGIS/build/z")
...
ELSE(WIN32)
    IF(UNIX)
        ...
        FIND_PATH(QGIS_PLUGIN_DIR
            ...
            PATHS
            ${LOCAL_QGIS_PATH}/lib/qgis/plugins
