...
public:
    ...
    void setupUi(QWidget *QgsAttributesFormProperties)
    {
        ...
        mShowAliasesButton = new QToolButton(widget_2);
        mShowAliasesButton->setObjectName(QString::fromUtf8("mShowAliasesButton"));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/themes/default/mIconFonts.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mShowAliasesButton->setIcon(icon);
        mShowAliasesButton->setCheckable(true);

        horizontalLayout->addWidget(mShowAliasesButton);

        mTbInitCode = new QToolButton(widget_2);
        mTbInitCode->setObjectName(QString::fromUtf8("mTbInitCode"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/images/themes/default/processingScript.svg"), QSize(), QIcon::Normal, QIcon::Off);
        mTbInitCode->setIcon(icon1);
        ...
        mRemoveLayoutItemButton->setIcon(icon2);

        gridLayout_3->addWidget(mRemoveLayoutItemButton, 2, 2, 1, 1);
        ...
        mAddContainerButton->setIcon(icon3);

        gridLayout_3->addWidget(mAddContainerButton, 0, 2, 1, 1);
        ...
        QWidget::setTabOrder(mEditorLayoutComboBox, mShowAliasesButton);
        QWidget::setTabOrder(mShowAliasesButton, mTbInitCode);
        ...
        QWidget::setTabOrder(pbnSelectEditForm, mAddContainerButton);
