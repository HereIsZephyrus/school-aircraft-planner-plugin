...
public:
    ...
    void setupUi(QDialog *QgsOracleNewConnectionBase)
    {
        ...
        QgsOracleNewConnectionBase->resize(878, 637);
        ...
        gridLayout_1->addWidget(btnConnect, 10, 0, 1, 3);

        verticalSpacer_2 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_1->addItem(verticalSpacer_2, 11, 1, 1, 1);
        ...
        gridLayout1->addWidget(TextLabel3_5, 7, 0, 1, 1);
        ...
        gridLayout1->addWidget(cb_useEstimatedMetadata, 3, 0, 1, 2);
        ...
        gridLayout1->addWidget(cb_geometryColumnsOnly, 0, 0, 1, 2);
