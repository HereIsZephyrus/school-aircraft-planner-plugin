...
public:
    ...
    void setupUi(QDialog *QgsTransformSettingsDialog)
    {
        ...
        sizePolicy1.setHeightForWidth(dsbVerticalRes->sizePolicy().hasHeightForWidth());
        dsbVerticalRes->setSizePolicy(sizePolicy1);
        ...
        sizePolicy2.setHeightForWidth(cmbTransformType->sizePolicy().hasHeightForWidth());
        cmbTransformType->setSizePolicy(sizePolicy2);
        ...
        QWidget::setTabOrder(cmbResampling, mWorldFileCheckBox);
