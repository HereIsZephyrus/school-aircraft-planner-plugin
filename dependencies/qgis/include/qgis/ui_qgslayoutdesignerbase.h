...
#endif // QT_CONFIG(shortcut)
        mActionSelectMoveItem->setText(QCoreApplication::translate("QgsLayoutDesignerBase", "Select/Move/Link Item", nullptr));
#if QT_CONFIG(tooltip)
        mActionSelectMoveItem->setToolTip(QCoreApplication::translate("QgsLayoutDesignerBase", "Select/Move/Link item", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
