...
public:
    ...
    void setupUi(QDialog *QgsVectorLayerPropertiesBase)
    {
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 271, 532));
        ...
        scrollAreaWidgetContents_7->setGeometry(QRect(0, 0, 116, 97));
        ...
        scrollAreaWidgetContents_19->setGeometry(QRect(0, 0, 601, 688));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 677, 712));
        ...
        mOptionsStackedWidget->setCurrentIndex(18);
