...
public:
    ...
    void setupUi(QDialog *QgsVectorTileLayerPropertiesBase)
    {
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 289, 376));
        ...
        mMapLayerServerPropertiesWidget = new QgsMapLayerServerPropertiesWidget(mOptsPage_Server);
        mMapLayerServerPropertiesWidget->setObjectName(QString::fromUtf8("mMapLayerServerPropertiesWidget"));

        verticalLayout_9->addWidget(mMapLayerServerPropertiesWidget);
