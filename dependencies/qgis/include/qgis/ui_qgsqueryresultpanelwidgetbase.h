...
public:
    ...
    void setupUi(QWidget *QgsQueryResultPanelWidgetBase)
    {
        ...
        QgsQueryResultPanelWidgetBase->resize(662, 471);
        ...
        mQueryResultsTableView = new QTableView(splitter);
        mQueryResultsTableView->setObjectName(QString::fromUtf8("mQueryResultsTableView"));
        splitter->addWidget(mQueryResultsTableView);
        ...
        mSqlErrorText = new QgsCodeEditorSQL(QgsQueryResultPanelWidgetBase);
        mSqlErrorText->setObjectName(QString::fromUtf8("mSqlErrorText"));

        mainLayout->addWidget(mSqlErrorText);
    ...
    void retranslateUi(QWidget *QgsQueryResultPanelWidgetBase)
    {
        ...
        mStatusLabel->setText(QCoreApplication::translate("QgsQueryResultPanelWidgetBase", "Status and errors goes here.", nullptr));
